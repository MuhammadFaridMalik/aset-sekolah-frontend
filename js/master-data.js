...
const tabPanels = {
  ...
  lokasi: document.getElementById("tabLokasi"),
};
...
function openMasterModal(type, id = "", name = "", building = "") {
  ...
  document.getElementById("masterNameLabel").textContent =
    type === "category" ? "Nama Kategori" : "Nama Ruangan";
  document.getElementById("masterBuildingGroup").style.display =
    type === "location" ? "block" : "none";
